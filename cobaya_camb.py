...
class CAMB(BoltzmannBase):
    ...
    def get_can_support_params(self):
        ...
        if not self.external_primordial_pk:
            params += ["sigma8"]
        # Add grey body radiation parameters
        params += ["custom_emissivity", "transition_redshift", "epsilon_gamma",
                   "z_gamma_inj", "dz_gamma", "use_grey_body_radiation", "grey_body_pad"]
        return params
    ...
    def set(self, params_values_dict, state):
        ...
        # Always force grey body params at every evaluation
        args["use_grey_body_radiation"] = 1
        args["transition_redshift"] = 17.0
        # Generate and save
