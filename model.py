...
class CAMBparams(F2003Class):
    ...
    _fields_ = [
        ...
        ("custom_emissivity", c_double),
        ("transition_redshift", c_double),
        ("transition_width", c_double),
        ("epsilon_gamma", c_double),
        ("z_gamma_inj", c_double),
        ("dz_gamma", c_double),
        ("use_grey_body_radiation", c_int),
        ("grey_body_pad", c_int),
