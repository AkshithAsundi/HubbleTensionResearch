    ...
    type, extends (TCAMBParameters) :: CAMBparams
        ...
        ! Grey body radiation parameters
        real(dl) :: custom_emissivity = 1.0_dl
        real(dl) :: transition_redshift = 0.0_dl
        real(dl) :: transition_width = 2.5_dl
        real(dl) :: epsilon_gamma = 1.0_dl
        real(dl) :: z_gamma_inj = 17.0_dl
        real(dl) :: dz_gamma = 2.0_dl
        integer :: use_grey_body_radiation = 0
        integer :: grey_body_pad = 0
